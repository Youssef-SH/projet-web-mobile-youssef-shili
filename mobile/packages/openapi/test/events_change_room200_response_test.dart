...
// tests for EventsChangeRoom200Response
void main() {
  final instance = EventsChangeRoom200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(EventsChangeRoom200Response, () {
    ...
    // EventRoomChangeResponseDto data

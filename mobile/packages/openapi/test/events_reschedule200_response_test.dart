...
// tests for EventsReschedule200Response
void main() {
  final instance = EventsReschedule200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(EventsReschedule200Response, () {
    ...
    // EventRescheduleResponseDto data

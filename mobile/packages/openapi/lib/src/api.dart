...
import 'package:openapi/src/api/clubs_api.dart';
import 'package:openapi/src/api/events_api.dart';
import 'package:openapi/src/api/health_api.dart';

class Openapi {
  static const String basePath = r'https://isimm-clubhub-api.onrender.com';
  ...
  /// Get ClubsApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  ClubsApi getClubsApi() {
    return ClubsApi(dio, serializers);
  }

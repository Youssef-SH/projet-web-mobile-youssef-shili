...
class _$ResetPasswordResponseDto extends ResetPasswordResponseDto {
  ...
  _$ResetPasswordResponseDto._({required this.success}) : super._();
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is ResetPasswordResponseDto && success == other.success;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ResetPasswordResponseDto')
          ..add('success', success))
        .toString();
  }
}
    ...
    final _$result = _$v ??
        _$ResetPasswordResponseDto._(
          success: BuiltValueNullFieldError.checkNotNull(
              success, r'ResetPasswordResponseDto', 'success'),
        );
    replace(_$result);
    return _$result;
  }

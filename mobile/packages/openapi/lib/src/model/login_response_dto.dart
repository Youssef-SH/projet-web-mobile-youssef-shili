...
/// * [refreshToken] - JWT refresh token used to renew the access token
/// * [user] - Snapshot of the authenticated user
@BuiltValue()
...
class _$LoginResponseDtoSerializer implements PrimitiveSerializer<LoginResponseDto> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.user,
      specifiedType: const FullType(LoginUserSnapshotDto),
    );
  }

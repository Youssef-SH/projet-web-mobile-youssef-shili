    ...
    try {
      _$result = _$v ??
          _$AuthChangePassword200Response._(
            code: BuiltValueNullFieldError.checkNotNull(
                code, r'AuthChangePassword200Response', 'code'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'AuthChangePassword200Response', 'message'),
            data: data,
            error: _error?.build(),
            requestId: BuiltValueNullFieldError.checkNotNull(
                requestId, r'AuthChangePassword200Response', 'requestId'),
            timestamp: BuiltValueNullFieldError.checkNotNull(
                timestamp, r'AuthChangePassword200Response', 'timestamp'),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'AuthChangePassword200Response', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);

    ...
    try {
      _$result = _$v ??
          _$AuthRefresh200Response._(
            code: BuiltValueNullFieldError.checkNotNull(
                code, r'AuthRefresh200Response', 'code'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'AuthRefresh200Response', 'message'),
            data: data,
            error: _error?.build(),
            requestId: BuiltValueNullFieldError.checkNotNull(
                requestId, r'AuthRefresh200Response', 'requestId'),
            timestamp: BuiltValueNullFieldError.checkNotNull(
                timestamp, r'AuthRefresh200Response', 'timestamp'),
          );
    } catch (_) {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'AuthRefresh200Response', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);

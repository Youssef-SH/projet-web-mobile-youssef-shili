...
class AuthMe200ResponseBuilder
    implements
        Builder<AuthMe200Response, AuthMe200ResponseBuilder>,
  ...
  @override
  void replace(covariant AuthMe200Response other) {
      ...
      _$result = _$v ??
          _$AuthMe200Response._(
            code: BuiltValueNullFieldError.checkNotNull(
                code, r'AuthMe200Response', 'code'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'AuthMe200Response', 'message'),
            data: data,
            error: _error?.build(),
            requestId: BuiltValueNullFieldError.checkNotNull(
                requestId, r'AuthMe200Response', 'requestId'),
            timestamp: BuiltValueNullFieldError.checkNotNull(
                timestamp, r'AuthMe200Response', 'timestamp'),
          );
    } catch (_) {
